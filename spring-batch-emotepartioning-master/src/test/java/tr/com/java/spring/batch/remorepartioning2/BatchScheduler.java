...
import tr.com.java.spring.batch.remotepartioning.aggregating.ManagerConfiguration;

@EnableScheduling
@Configuration
@Import(value = { DataSourceConfiguration.class, ManagerConfiguration.class })
