...
public class ClusterClientTest  {
  ...
  Set<ActorPath> initialContacts() {
    return new HashSet<ActorPath>(
        Arrays.asList(
            ActorPaths.fromString("akka.tcp://cluster@127.0.0.1:2551/system/receptionist"),
            ActorPaths.fromString("akka.tcp://cluster@127.0.0.1:2552/system/receptionist")));
  }
  // #initialContacts
  ...
  public static void main(String[] args) {
	  ClusterClientTest client = new ClusterClientTest();
